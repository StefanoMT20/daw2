...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain,
         ...
         // 1. Obtiene los detalles del usuario autenticado
        // CAMBIO AQUÍ: Castea a org.springframework.security.core.userdetails.User
        org.springframework.security.core.userdetails.User userSpringSecurity = 
            (org.springframework.security.core.userdetails.User) authResult.getPrincipal();
        
        // 2. Crea el JWT - usa el email (username) del objeto de Spring Security
        String token = Token.crearToken(userSpringSecurity.getUsername(), userSpringSecurity.getUsername()); // Usar getUsername()
         // 3. Añade el JWT a la cabecera de la respuesta HTTP
